...
start_button = ctk.CTkButton(app, text="Start Capture", command=start_capture)
start_button.pack(pady=10)

stop_button = ctk.CTkButton(app, text="Stop Capture", command=stop_capture)
stop_button.pack(pady=10)

increase_button = ctk.CTkButton(app, text="Increase Interval", command=increase_time)
increase_button.pack(pady=10)

decrease_button = ctk.CTkButton(app, text="Decrease Interval", command=decrease_time)
